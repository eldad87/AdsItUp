 ...
 */
class Version20151016033156 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE brand_record ADD CONSTRAINT FK_18BCE39F414CE44B FOREIGN KEY (commission_plan_id) REFERENCES commission_plan (id)');
